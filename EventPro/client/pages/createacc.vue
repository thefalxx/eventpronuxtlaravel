<template>
    ...
    <div class="antialiased pt-20 pb-20">
        <div class="max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow shadow-slate-300">
            <h1 class="text-4xl font-medium">Create Account</h1>
            <p class="text-slate-500">It's quick and easy!</p>
            ...
            <form action="" class="my-10">
                <div class="flex flex-col space-y-5">
                    ...
                    <p class="text-center">Already have an account? <NuxtLink to="login" href="#" class="text-indigo-600 font-medium inline-flex space-x-1 items-center">
                        <span>Sign in </span><span><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
