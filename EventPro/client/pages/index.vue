...
<!-- Page Main -->
    ...
    <section
        ...
        <!-- Column-1 -->
        <div class="px-3 w-full lg:w-2/5 pl-20">
            <div
            ...
            <div class="text-center lg:text-left">
                <a
                    class="block visible py-4 px-8 mb-4 text-s font-semibold tracking-wide leading-none text-white bg-blue-500 rounded cursor-pointer sm:mr-3 sm:mb-0 sm:inline-block"
                    @click="navigateTo('createacc')"
                    >Get Started</a
                >
            </div>
        </div>
        ...
        <!-- Column-2 -->
        <div class="px-3 mb-12 w-full lg:mb-0 lg:w-3/5 pl-20">
    ...
    <section id="service"
        ...
        ">
        <h1 class="text-white text-5xl font-bold mb-10 ">
            Services 
        </h1>

        <span class="text-center font-semibold my-20 text-white/90">
            <p>
...
<section id="about">
    ...
    <div class="container xl:max-w-6xl mx-auto px-4">
        ...
        <header class="text-center mx-auto mb-10 lg:px-20">
            <h2 class="text-4xl leading-normal mb-2 font-bold text-black">About EventPro</h2>
            ...
            <p class="text-gray-500 leading-relaxed font-light text-xl mx-auto">An event managing system that handles everything all in one application</p>
        </header>
        <!-- End heading -->
        <!-- row -->
        <div class="flex flex-wrap flex-row -mx-4 text-center">
            <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">
                <!-- service block -->
                <div class=" shadow-md py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                    ...
                    <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Create and Plan Events</h3>
            ...
            <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInUp;">
                ...
                <div class="shadow-md py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                    ...
                    <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Event Tracker</h3>
                    <p class="text-gray-500">This is a wider card with supporting text below as a natural content.</p>
                </div>
                <!-- end service block -->
            </div>
            <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" style="visibility: visible; animation-duration: 1s; animation-name: fadeInUp;">
                ...
                <div class="shadow-md py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                    ...
                    <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Schedules</h3>
                    <p class="text-gray-500">This is a wider card with supporting text below as a natural content.</p>
                </div>
                <!-- end service block -->
            </div>
            <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.1s; animation-name: fadeInUp;">
                ...
                <div class="shadow-md py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                    ...
                    <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Budgeting</h3>
                    <p class="text-gray-500">This is a wider card with supporting text below as a natural content.</p>
                </div>
                <!-- end service block -->
            </div>
            <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.3s; animation-name: fadeInUp;">
                ...
                <div class="shadow-md py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                    ...
                    <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Manage Events</h3>
                    <p class="text-gray-500">This is a wider card with supporting text below as a natural content.</p>
                </div>
                <!-- end service block -->
                </div>
            <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.3s; animation-name: fadeInUp;">
                ...
                <div class="shadow-md py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2">
                    ...
                    <h3 class="text-lg leading-normal mb-2 font-semibold text-black">User Management</h3>
                    <p class="text-gray-500">This is a wider card with supporting text below as a natural content.</p>
                </div>
                <!-- end service block -->
            </div>
