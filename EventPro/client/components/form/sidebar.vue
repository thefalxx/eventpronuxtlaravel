<template>
        <div class="font-poppins antialiased">
          <div id="view"
          class="h-full flex flex-row fixed"
          x-data="{ sidenav: true}"
          >
          <button
            @click="sidenav = true"
      ...
      >
        <div class="space-y-6 md:space-y-10 mt-10">
            <h1 class="hidden md:block font-bold text-sm md:text-xl text-center text-blue-600">
              EventPro
            </h1>

            <div class="flex border-2 border-gray-200 rounded-md focus-within:ring-2 ring-blue-500">
              <input
              type="text"
